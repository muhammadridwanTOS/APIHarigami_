    ...
    public class JundateArea
    {
        public Response GetList(string? constr, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_Setting_Area_List";
                    ...
                    //===================================================
                    //For only get list HrgmJundateID Master by @HrgmJundateID
                    //===================================================
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on Get List Jundate Area!, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on Get List Jundate Area!, Error Message = " + ex.Message;
                resp.Contents = "";
            }
        ...
        public Response CRUD(string? constr, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_Setting_Area_IUD";
                    ...
                    {
                        cmd.Parameters.AddWithValue("HrgmJundateAreaName", data[0].HrgmJundateAreaName.ToString()); 
                        cmd.Parameters.AddWithValue("HrgmJundateAreaDesc", data[0].HrgmJundateAreaDesc.ToString());  
                        cmd.Parameters.AddWithValue("TPCode", data[0].TPCode.ToString());  
                    }
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on Update Jundate Area!, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on Update Jundate Area!, Error Message = " + ex.Message;
                resp.Contents = "";
            }
        ...
        public Response UploadValidation(string? constr, List<dynamic> data)
        {
            ...
            Response resp = new Response();
            string sql = "sp_Setting_Area_UploadValidation";
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API on Upload Validation Jundate Area Master!, Error Message = " + ex.Message;
                resp.Contents = "";
            }
        ...
        public Response Upload(string? constr, string UserID, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_Setting_Area_Upload";
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on upload Jundate Area Master !, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on upload Jundate Area Master !, Error Message = " + ex.Message;
                resp.Contents = "";
            }
            return resp;
        }
