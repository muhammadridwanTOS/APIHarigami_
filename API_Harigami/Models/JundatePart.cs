...
{
    public class JundatePart
    {
        public Response GetList(string? constr, string ActionType, string UserID, string HrgmJundateIDArea, string ModelCode, string Ktsk, string Sfx, string ColorCode, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_Setting_Part_List";
        ...
        public Response InsertReplace(string? constr, string UserID , string HrgmJundateIDArea , string ModelCode, string Ktsk, string Sfx, string ColorCode, List<dynamic> data)
        {
            Response resp = new Response();
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on Jundate Part !, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on Jundate Part Insert !, Error Message = " + ex.Message;
                resp.Contents = "";
            }
            return resp;
        }
        ...
        public Response UploadValidation(string? constr, List<dynamic> data)
        {
            ...
            Response resp = new Response();
            string sql = "sp_Setting_Part_UploadValidation";
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API on Upload Validation Jundate Part Master!, Error Message = " + ex.Message;
                resp.Contents = "";
            }
        ...
        public Response Upload(string? constr, string UserID, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_Setting_Part_Upload";
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on upload Jundate Part !, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on upload Jundate Part !, Error Message = " + ex.Message;
                resp.Contents = "";
            }
            return resp;
        }
