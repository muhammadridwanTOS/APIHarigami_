...
{
    public class MainlaneAreaPart
    {
        public Response GetList(string? constr, string ActionType, string UserID, string HrgmMainIDArea, string ModelCode, string Ktsk, string Sfx, string ColorCode, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_MainLane_Part_List";

                    SqlCommand cmd = new(sql, con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("ActionType", ActionType);
                    cmd.Parameters.AddWithValue("UserID", UserID);
                    cmd.Parameters.AddWithValue("HrgmMainIDArea", HrgmMainIDArea);
        ...
        public Response InsertReplace(string? constr, string UserID , string HrgmMainIDArea , string ModelCode, string Ktsk, string Sfx, string ColorCode, List<dynamic> data)
        {
            Response resp = new Response();
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on Process Template Process Template !, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on Process Template Insert !, Error Message = " + ex.Message;
                resp.Contents = "";
            }
            return resp;
        }
        ...
        public Response UploadValidation(string? constr, List<dynamic> data)
        {
            ...
            Response resp = new Response();
            string sql = "sp_Mainlane_Part_UploadValidation";
        ...
        public Response Upload(string? constr, string UserID, List<dynamic> data)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string sql = "sp_MainLane_Part_Upload";
            ...
            {
                resp.ID = "1";
                resp.Message = "Error API SQL on upload Process Template !, Error Message = " + exsql.Message;
                resp.Contents = "";
            }
            catch (Exception ex)
            {
                resp.ID = "1";
                resp.Message = "Error API on upload Process Template !, Error Message = " + ex.Message;
                resp.Contents = "";
            }
            return resp;
        }
